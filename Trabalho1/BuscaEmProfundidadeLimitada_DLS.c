...
// Simula uma busca em profundidade limitada (DLS) em um grafo de hipóteses médicas
// O objetivo é encontrar diagnósticos prováveis com base em sintomas e conexões médicas
...
//essa base foi criada com auxilio de IA pq é muita coisa pra fazer na mão
